...
<div class="mx-auto mt-5 mb-10">
    <form action="<?= base_url('indikatorKinerja/edit') ?>" id="form-add-indikator" method="POST" show-validation>
        ...
        <div class="form-control">
            ...
            <input type="number" name="target" id="target" class="input input-bordered" min="0" value="60">
        </div>

        <div class="form-control my-3 text-center">
            <label class="label cursor-pointer justify-start">
                <input type="checkbox" class="checkbox" name="is_jurusan" id="is_jurusan" checked />
        ...
        <div class="grid grid-cols-12 gap-3">
            <div class="lg:col-span-6 col-span-12 is-fakultas">
                <div class="form-control">
                    ...
                    <textarea class="textarea textarea-bordered" name="ket_fakultas" id="ket_fakultas" placeholder="Masukkan keterangan IK untuk fakultas">Persentasi lulusan yang berhasil mendapatkan pekerjaan, melanjutkan studi dan menjadi wirausaha</textarea>
                </div>
                ...
                <div class="form-control">
                    ...
                    <select name="cascading_fakultas" id="cascading_fakultas" multiple="multiple" data-placeholder="Pilih Cascading" class="select select-bordered" style="width: 100%;">
                        <option value="1" selected>Wakil Dekan I</option>
                        <option value="2">Wakil Dekan II</option>
                        <option value="3" selected>Wakil Direktur I PPS</option>
            ...
            <div class="lg:col-span-6 col-span-12 is-jurusan">
                <div class="form-control">
                    <label for="ket_jurusan" class="label">
                        <span class="label-text label-required">Keterangan (Jurusan)</span>
                    </label>
                    <textarea class="textarea textarea-bordered" name="ket_jurusan" id="ket_jurusan" placeholder="Masukkan keterangan IK untuk jurusan">Persentase lulusan yang berhasil mendapatkan pekerjaan, melanjutkan studi, dan menjadi wirausaha</textarea>
                </div>
                ...
                <div class="form-control">
                    ...
                    <select name="cascading_jurusan" id="cascading_jurusan" multiple="multiple" data-placeholder="Pilih Cascading" class="select select-bordered" style="width: 100%;">
                        ...
                        <option value="11">Kepala UPT Pusat Mitigasi Bencana</option>
                        <option value="12">Jurusan</option>
                        <option value="13" selected>Prodi S1</option>
                        <option value="14">Prodi S2</option>
                        <option value="15" selected>Prodi D3</option>
                    </select>
                </div>
            </div>
        </div>
