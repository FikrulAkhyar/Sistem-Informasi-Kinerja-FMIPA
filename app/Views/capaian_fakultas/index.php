        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, _, row) {
                    ...
                    let akses = row.level_akses.split(',')
                    let btn_edit = akses.includes(level) ? `<button data-reference="${row.capaian_fakultas_id}" class="btn btn-warning btn-sm btn-edit-modal text-white" data-tippy-content="Isi Capaian">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                </svg>
                            </button>` : ``
                    let btn_berkas = row.file != null ? `<button data-reference="${row.file}" class="btn btn-error btn-sm btn-unduh-dokumen text-white" data-tippy-content="Unduh Berkas Capaian">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    return `
                       <div class="flex justify-center gap-2">
                            ${btn_berkas}
                            <button data-reference="${row.capaian_fakultas_id}" class="btn btn-info btn-sm btn-detail-modal text-white" data-tippy-content="Detail Capaian">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
