        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, _, row) {
                    ...
                    let btn_edit = akses.includes(level) ? `<button data-reference="${row.capaian_jurusan_id}" class="btn btn-warning btn-sm btn-edit-modal text-white" data-tippy-content="Isi Capaian">
                    ...
                    return `
                       <div class="flex justify-center gap-2">
                            ${btn_berkas}
                            <button data-reference="${row.capaian_jurusan_id}" class="btn btn-info btn-sm btn-detail-modal text-white" data-tippy-content="Detail Capaian">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
